var Planner = require('csa').BasicCSA,
    ...
    TransferTimesFetcher = require('./TransferTimesFetcher');
...
var Client = function (config) {
  ...
  //Create fetcher for transfer times
  this._transferTimesFetcher = new TransferTimesFetcher(config,this._http);
}
...
Client.prototype.query = function (q, cb) {
  ...
  fetcher.buildConnectionsStream(q, function (connectionsStream) {
    ...
    var planner = new Planner(q,self._transferTimesFetcher);
